...
from .views import QuizListView,QuizAdminCreateView, QuizAdminUpdateView, QuizAdminDeleteView, QuizAdminListView, RequestExplorerView, CategoryAdminListView, CategoryAdminCreateView, CategoryAdminUpdateView, CategoryAdminDeleteView
...
urlpatterns = [
    ...
    path("admin/quizzes/", QuizAdminListView.as_view(), name="quiz_admin"),
